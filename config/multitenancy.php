...
return [
     ...
     */
    'tenant_finder' => \App\Modules\Tenancy\TenantFinder\SubdomainTenantFinder::class,

    /*
     * The base domain used for subdomain tenant detection.
     * Tenants are resolved from: {slug}.{base_domain}
     */
    'base_domain' => env('MULTITENANCY_BASE_DOMAIN', 'mahir.test'),
     ...
     */
    'tenant_database_connection_name' => env('MULTITENANCY_TENANT_DATABASE_CONNECTION_NAME', 'tenant'),

    /*
     * The connection name to reach the landlord database.
     */
    'landlord_database_connection_name' => env('MULTITENANCY_LANDLORD_DATABASE_CONNECTION_NAME', 'landlord'),
